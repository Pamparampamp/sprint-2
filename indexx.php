...
$sql = 'DELETE FROM projectss WHERE id = ?';
...
if (mysqli_num_rows($result) > 0) {
  print('<a href="index.php"><button>DARBUOTOJAI</button></a>');
print('<table>');
print('<thead>');
print('<tr><th>Id</th><th>Name</th><th>Surname</th><th>Projects</th><th>Actions</th></tr>');
print('</thead>');
print('<tbody>');
